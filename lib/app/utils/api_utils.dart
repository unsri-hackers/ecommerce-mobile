...
class ApiUtils {
  ...
  static String userProfile = AppConfig.baseUrl +"/user";
  //"https://run.mocky.io/v3/2beab3e1-b04c-4809-81bc-48d6f088ff19";
  ...
  // static String yourProducts =listProductsPaging;
